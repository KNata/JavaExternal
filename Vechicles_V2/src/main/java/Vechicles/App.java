...
public class App
{
    public static void main( String[] args ) {
        ...
        ArrayList<Plane> planeResList = theService.findPlanedByConditions();
...
//        ArrayList<Vechicle> vechicleResList = theService.returnListOfVechiclesWithMaxSppedExeptPlanes();
...
//        }
        ...
        ArrayList<BetMobile> bmList = theService.checkInstanceOfIMovebbleInterfaceToBetmobile();
        System.out.println("Bet Mobile with max speed " + bmList.get(0).getVechicleSpeed());
        ArrayList<AmfibianCar> amList = theService.checkInstanceOfIMovebbleInterfaceToAmphibianCar();
        System.out.println("Amphibian car with max speed " + amList.get(0).getVechicleSpeed());

        System.out.println();
        System.out.println("Interface IFlywable");
        ArrayList<BetMobile> bmListF = theService.checkInstanceOfIFlyvableInterfaceToBetmobile();
        System.out.println("Bet Mobile with max speed " + bmListF.get(0).getVechicleSpeed());

        System.out.println();
        System.out.println("Interface ISwimable");
        ArrayList<BetMobile> bmListS = theService.checkInstanceOfISwimableInterfaceToBetmobile();
        System.out.println("Bet Mobile with max speed " + bmListS.get(0).getVechicleSpeed());
        ArrayList<AmfibianCar> amListS = theService.checkInstanceOfISwimableInterfaceToAmphibianCar();
